...
// const loadNodes = () => import('./windows/Nodes'); // Hidden: hermes-agent has no multi-node support
...
const WINDOW_LOADERS: Record<WindowID, () => Promise<unknown>> = {
  ...
  // nodes: loadNodes, // Hidden: hermes-agent has no multi-node support
...
// const Nodes = React.lazy(loadNodes); // Hidden: hermes-agent has no multi-node support
