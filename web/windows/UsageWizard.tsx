        ...
        {isComplete && (
          <div className="rounded-2xl border-2 border-mac-green/40 bg-gradient-to-br from-mac-green/[0.06] to-emerald-500/[0.03] p-5 text-center">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <button onClick={() => dispatchOpenWindow({ id: 'knowledge' })}
        ...
        <div className={`rounded-2xl border p-4 ${statusTone}`}>
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[11px] theme-text-secondary mt-0.5">{o?.capabilitySubtitle || 'These settings directly change what Hermes Agent can do, even if the system is otherwise healthy.'}</p>
