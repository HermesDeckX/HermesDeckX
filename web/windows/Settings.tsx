...
const Settings: React.FC<SettingsProps> = ({ language, onLogout, pendingTab, onTabConsumed, onPrefsChange, badges = {} }) => {
  ...
  // Tab switching from hermesdeck:open-window is handled centrally via pendingTab prop from App.tsx
  ...
  // ── 访问安全 ──
  const [srvCfg, setSrvCfg] = useState<ServerConfig>({ bind: '0.0.0.0', port: 19788, cors_origins: [], hermeshub_query_url: 'https://wry-manatee-359.convex.cloud/api/query', skillhub_data_url: 'https://cloudcache.tencentcs.com/qcloud/tea/app/data/skills.33d56946.json' });
  const [srvCfgOriginal, setSrvCfgOriginal] = useState<ServerConfig>({ bind: '0.0.0.0', port: 19788, cors_origins: [], hermeshub_query_url: 'https://wry-manatee-359.convex.cloud/api/query', skillhub_data_url: 'https://cloudcache.tencentcs.com/qcloud/tea/app/data/skills.33d56946.json' });
  ...
  const fetchServerConfig = useCallback(() => {
    serverConfigApi.get().then((data) => {
      const cfg: ServerConfig = {
        ...
        port: data.port || 19788,
        cors_origins: data.cors_origins || [],
        hermeshub_query_url: data.hermeshub_query_url || 'https://wry-manatee-359.convex.cloud/api/query',
      ...
      <aside className={`fixed md:static top-[32px] bottom-[72px] md:top-auto md:bottom-auto start-0 z-50 w-64 md:w-56 lg:w-64 shrink-0 border-e border-slate-200/70 dark:border-white/[0.06] bg-[#f5f5f7] dark:bg-[#2c2c2e] md:bg-[#f5f5f7]/80 md:dark:bg-[#2c2c2e]/80 backdrop-blur-xl flex flex-col overflow-y-auto no-scrollbar transform transition-transform duration-200 ease-out ${drawerOpen ? 'translate-x-0' : '-translate-x-full rtl:translate-x-full md:translate-x-0'}`}>
        ...
        <div className="flex items-center gap-3 px-4 py-5 border-b border-slate-200/70 dark:border-white/[0.06]">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] theme-text-muted">HermesDeckX</p>
          </div>
        </div>
                ...
                <div className="px-4 py-3 space-y-4">
                  ...
                  <div>
                    ...
                    <input type="text" inputMode="numeric" value={srvCfg.port}
                      onChange={e => { const v = e.target.value.replace(/\D/g, ''); const n = parseInt(v) || 0; if (n >= 0 && n <= 65535) updateSrvCfg({ port: n || 19788 }); }}
              ...
              <div className={rowCls}>
                <div className="px-4 py-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <SmartLink href="https://github.com/HermesDeckX/HermesDeckX/issues"
                      className="flex items-center gap-2 px-3 py-2.5 rounded-lg theme-field hover:bg-slate-100 dark:hover:bg-white/10 transition-colors">
          ...
          {activeTab === 'about' && (
            <div className="space-y-6">
              ...
              <div className="flex flex-col items-center pt-4 pb-2">
                ...
                <h3 className="text-[20px] font-bold text-slate-800 dark:text-white tracking-wide">HermesDeckX</h3>
              ...
              <div className={rowCls}>
                <div className="px-5 py-4">
                  ...
                  <div className="space-y-2">
                    <SmartLink href="https://github.com/NousResearch/hermes-agent"
                      ...
                      <img src="hermeslogo.ico" alt="HermesAgent" className="w-[20px] h-[20px]" />
                      <div className="flex-1 min-w-0">
                        <p className="text-[13px] font-bold text-slate-700 dark:text-white/70 group-hover:text-primary">HermesAgent</p>
                        <p className="text-[10px] text-slate-400 dark:text-white/20 truncate">github.com/NousResearch/hermes-agent</p>
                      </div>
                    ...
                    <SmartLink href="https://clawdeckx.com"
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-[13px] font-bold text-slate-700 dark:text-white/70 group-hover:text-primary">HermesDeckX</p>
                        <p className="text-[10px] text-slate-400 dark:text-white/20 truncate">HermesDeckX.com</p>
                      </div>
                      <span className="material-symbols-outlined text-[14px] text-slate-300 dark:text-white/15 group-hover:text-primary">open_in_new</span>
                    </SmartLink>
                  </div>
              ...
              <p className="text-center text-[10px] text-slate-300 dark:text-white/10 pb-2">
                &copy; {new Date().getFullYear()} HermesDeckX &middot; Made with &#x2764;&#xFE0F;
              </p>
            </div>
          )}
