...
func (h *SettingsHandler) SetGWClient(client *hermes.GWClient) {
	h.gwClient = client
}

// SetGWService injects the HermesAgent service reference.
func (h *SettingsHandler) SetGWService(svc *hermes.Service) {
	h.gwService = svc
}
