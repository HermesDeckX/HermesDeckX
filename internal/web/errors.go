...
var (
	...
	ErrConfigValidateCLIAbsent = &AppError{"CONFIG_VALIDATE_CLI_UNAVAILABLE", "hermes CLI is unavailable for config validation", 412, nil}
)
...
var (
	ErrHermesAgentNotInstalled = &AppError{"HERMES_AGENT_NOT_INSTALLED", "hermesagent is not installed", 412, nil}
...
var (
	ErrHermesHubFailed = &AppError{"HERMESHUB_FAILED", "HermesHub request failed", 502, nil}
)
