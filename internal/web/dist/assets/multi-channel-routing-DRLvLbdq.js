const n="多频道路由",o="同一个 AI 同时服务多个聊天平台，每个频道可以有不同的行为规则",l={body:`## 什么是多频道路由？
...
- 使用 \`hermesagent channels status --probe\` 验证所有频道状态`},e={name:n,description:o,content:l};export{l as content,e as default,o as description,n as name};
