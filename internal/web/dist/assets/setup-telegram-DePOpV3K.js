const e="连接 Telegram",t="创建 Telegram Bot 并通过 HermesDeckX 连接到 HermesAgent 网关",o={body:`Telegram 是 HermesAgent 最常用的消息频道之一。你需要先通过 BotFather 创建一个 Bot，然后在 HermesDeckX 中填入 Token 完成连接。
...
3. 在群组中 @提及 Bot 或回复 Bot 的消息来触发对话`}]},r={name:e,description:t,content:o};export{o as content,r as default,t as description,e as name};
