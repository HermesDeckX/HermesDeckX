const n="HermesDeckX 高效操作指南",e="掌握 HermesDeckX 桌面操作、配置中心导航和健康中心的实用技巧",s={body:`## 桌面导航
...
- **场景模板** — 内置多种场景模板（技术助手、翻译、写作等），一键应用`},o={name:n,description:e,content:s};export{s as content,o as default,e as description,n as name};
