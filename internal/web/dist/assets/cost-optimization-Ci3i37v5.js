const n="成本优化",e="通过心跳模型、活跃时段和压缩策略大幅降低 API 开支",t={body:`## 成本从哪里来？
...
在 HermesDeckX 的「使用统计」中查看 token 消耗趋势，及时发现异常。`},o={name:n,description:e,content:t};export{t as content,o as default,e as description,n as name};
